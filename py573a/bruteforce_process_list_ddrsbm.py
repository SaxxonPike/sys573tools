...
def process_entry(entry):
    fileinfo, input_dat, counter, output_key = entry

    if os.path.exists(output_key):
        return

    print("Processing", input_dat)
    key, scramble = bruteforce_keys.bruteforce_keys_ddrsbm(input_dat, counter, 0)
...
if __name__ == "__main__":
    ...
    for fileinfo in process_list:
        ...
        bucket.append((fileinfo, input_dat, counter, output_key))
