...
def read_file_table_gfdm2(filename, table_offset):
    files = []
    ...
    with open(filename, "rb") as infile:
        ...
        while True:
            ...
            files.append({
                ...
                'filesize': filesize,
                'flag_loc': 1 if offset >= 0x8000 else 0,
                'flag_comp': 1,
                'flag_enc': 0,
                'unk': 0,
                '_flag': flag,
...
def main():
    ...
    parser.add_argument('--type', help='Game Type', choices=['ddr', 'gfdm-old', 'gfdm-old2', 'gfdm-old3', 'gfdm-old4', 'gfdm', 'mambo', 'dmx'])
    ...
    if game_filename:
        used_regions[0] = {
            0: {
                ...
                'data': [0] * os.path.getsize(os.path.join(args.input, game_filename)),
            },
        }
